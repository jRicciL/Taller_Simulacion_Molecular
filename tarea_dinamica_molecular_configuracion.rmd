...
1. Descarga los **archivos de configuración** correspondientes a las siguientes fases de simulación:
   a) min_all.in -> Minimización de la energía potencial del sistema.
   b) heat.in -> Calentamiento del sistema.
   c) eq.in -> Equilibrado del sistema.
   d) prod.in -> Fase de producción de la dinámica molecular.
...
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSejRrmGGhKppqshNFE0e_U7WsPOfHF-Al3nesgGKumjtIZAwQ/viewform?embedded=true" width="720" height="5883" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>

***
# Referencias y Recursos

- [Manual Amber 2019](https://ambermd.org/doc12/Amber19.pdf){target="_blank"}
- [Tutoriales de Amber](https://ambermd.org/tutorials/){target="_blank"}