...
- 4️⃣ **En esta tarea no se ejecutará ningún comando.**

## Instrucciones
1. Descarga los **archivos de configuración** correspondientes a las siguientes fases de simulación:
   a) [min_all.in](https://raw.githubusercontent.com/jRicciL/Taller_Simulacion_Molecular/master/resurces/md/min_all.smi) -> Minimización de la energía potencial del sistema.
   b) [heat.in](https://raw.githubusercontent.com/jRicciL/Taller_Simulacion_Molecular/master/resurces/md/heat.smi) -> Calentamiento del sistema.
   c) [eq.in](https://raw.githubusercontent.com/jRicciL/Taller_Simulacion_Molecular/master/resurces/md/eq.smi) -> Equilibrado del sistema.
   d) [prod.in](https://raw.githubusercontent.com/jRicciL/Taller_Simulacion_Molecular/master/resurces/md/prod.smi) -> Fase de producción de la dinámica molecular.
...
***
## 1) Fase 1: Minimización de la energía potencial del sistema
...
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSejRrmGGhKppqshNFE0e_U7WsPOfHF-Al3nesgGKumjtIZAwQ/viewform?embedded=true" width="720" max-height="520" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>
