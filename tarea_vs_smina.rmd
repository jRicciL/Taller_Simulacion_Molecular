...
2. **En la diapositiva correspondiente, reporta las 3 mejores moléculas (con menor energía libre de interacción con la proteína) de cada ensayo de CV.**
   - Escribe el nombre, el valor de energía predicho y si la molécula es realmente activa o no.
...
6. 🚨 🚨 🚨 **Enviar únicamente el archivo pdf por mensaje personal a mi cuenta (Joel Ricci) en el Slack del grupo.**
7. <mark>Fecha límite de envío es el día viernes 26 de febrero a las 24:00 horas.</mark>
...
4. Basta con hacer la fase de preparación de los `pdbqt` una sola vez. 
