...
No obstante, quien decida tomar alguna de estas opciones deberá hacerlo por su cuenta. 
...
| 9      | [SSB.ova.7z.008](https://drive.google.com/file/d/1DVxzjTxX-dGkgbBa7AbjexuIGpI7PEsh/view?usp=sharing)       | 650 MB | |
| 10     | [SSB.ova.7z.008](https://drive.google.com/file/d/1hj7cvCUoRTkyjtFknRglHNeaECgUMW7N/view?usp=sharing)       | 368 MB | |
...
1. **Listo**  🎉 🎉 🎉. la máquina está instalada y puedes "encenderla" haciendo doble click sobre su nombre.  
<mark>La contraseña o password del superusuario es <i>ssb</i></mark>.


10.   Si hubiese algún problema con la máquina o con el sistema operativo, siempre puedes volver a usar el archivo **<mark>SSB.ova</mark>** para volver a la configuración inicial. Es decir, puedes echarla a perder sin culpa alguna. 
